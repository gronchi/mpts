...
def main(argv):
    try:
        tree = mds.Tree("mpts_manual", 1384, mode='ReadOnly')
    ...
    tree = mds.Tree("mpts_manual", 1385, mode='ReadOnly')
    ...
    ax1.plot(adc_time, adc_Ereturn, label="CMOS Laser")
    ax1.plot(adc_time, ch3, label="CMOS Plasma")
